...
def main(args):
    ...
    with open(args.config_filename) as f:
        ...
        learning_rate = 10 ** -4
        n_epochs = 1000 #700 t58 # 200 t62 # 500  t59#150  train 83, test 64,k=10
        batch_size = 32  # 64 -t58 32 -t64 -t57 62
        model = DynamicGNNdec(batch_size).to(device)
        ...
        printcsv(FinalTestAccuracy,learning_rate,n_epochs,batch_size,train_metrics_df,test_metrics_df,test_results_df)
        ...
        Model_file = modelPath + FinalTestAccuracy_str + '_3hcpMixupDynamic39k10dec' + timestr + extension
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_dir',
                        default='/home/sonalin/tech/gnnxf_al_test/setting/topk2/edgeconv_abide/',
                        type=str,
    ...
    for sl_data_i in sl_data:
        ...
        yaml_name = 'epoch3w_bz32_lr4_e_m_d'
        ...
        for i in range(args.repeat_time):
            ...
            run = wandb.init(project="brain_hcp_edgeconv_mixup_dec", entity=args.wandb, reinit=True,
