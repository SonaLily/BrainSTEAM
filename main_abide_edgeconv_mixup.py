...
def main(args):
    ...
    with open(args.config_filename) as f:
        ...
        learning_rate = 10 ** -4
        n_epochs = 10000  # 200 t62 # 500  t59#150  train 83, test 64,k=10
        batch_size = 32  # 64 -t58 32 -t64 -t57 62
...
if __name__ == '__main__':
    ...
    for sl_data_i in sl_data:
        ...
        yaml_name = 'epoch2w_bz32_lr4_e_m'
        ...
        for i in range(args.repeat_time):
            ...
            run = wandb.init(project="brain_abide_edgeconv_mixup", entity=args.wandb, reinit=True,
