...
from BrainedgeconvTrain import *
...
def main(args):
    ...
    with open(args.config_filename) as f:
        ...
        learning_rate = 10 ** -4
        n_epochs = 5000  # 200 t62 # 500  t59#150  train 83, test 64,k=10
        batch_size = 32  # 64 -t58 32 -t64 -t57 62
        ...
        best_model, train_result, train_metrics = brainedgetrain(model, train_loader, criterion, optimizer, n_epochs)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_dir',
                        default='/home/sonalin/tech/gnnxf_al_test/setting/topk2/topk_abide/',
                        type=str,
    ...
    for sl_data_i in sl_data:
        ...
        for i in range(args.repeat_time):
            wandb.login(key='xxxxxxxxxxxxxxxxxxxx')
            run = wandb.init(project="brain_abide_edgeconv", entity=args.wandb, reinit=True,
