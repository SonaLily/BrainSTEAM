...
def main(args):
    ...
    with open(args.config_filename) as f:
        ...
        learning_rate = 10 ** -4
        n_epochs = 10000 #700 t58 # 200 t62 # 500  t59#150  train 83, test 64,k=10
        batch_size = 32  # 64 -t58 32 -t64 -t57 62
        # model = GraphNetwork(batch_size)
        ...
        for window_size in [128]:  # [50, 64, 75, 100, 128, 256, 1200]:
            ...
            for fold in range(1, 5):
                ...
                train_data = np.load(
                    '/home/sonalin/tech/braindata/abide39/train_data_' + str(fold) + '.npy')
                train_label = np.load(
                    '/home/sonalin/tech/braindata/abide39/train_label_' + str(fold) + '.npy')
                test_data = np.load(
                    '/home/sonalin/tech/braindata/abide39/test_data_' + str(fold) + '.npy')
                test_label = np.load(
                    '/home/sonalin/tech/braindata/abide39/test_label_' + str(fold) + '.npy')
...
if __name__ == '__main__':
    ...
    for sl_data_i in sl_data:
        ...
        yaml_name = 'epoch2w_bz32_lr4_e_m_d_st'
        ...
        for i in range(args.repeat_time):
            ...
            run = wandb.init(project="brain_abide_edgeconv_mixup_dec_st", entity=args.wandb, reinit=True,
